...
shinyServer(function(input, output) {
   ...
   TweetFrame<-function(twtList)
  {
	...
	pos.words = scan('C:\\Users\\Lenovo\\Desktop\\Text-Sentiment-Analysis\\positive-words.txt', what='character', comment.char=';')
	neg.words = scan('C:\\Users\\Lenovo\\Desktop\\Text-Sentiment-Analysis\\negative-words.txt', what='character', comment.char=';')
